'use client'
// Import the correct router from 'next/router' instead of 'next/navigation'
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .eq('email', email) // Change 'username' to 'email'
      ...
      if (data && data.email && data.password) {
        ...
        router.push(`/SkillHive?username=${encodeURIComponent(data.username)}`);
      } else {
